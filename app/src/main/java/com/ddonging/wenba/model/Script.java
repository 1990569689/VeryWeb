...
package com.ddonging.wenba.model;
...
import com.ddonging.wenba.model.ScriptMetadata;
...
public class Script extends ScriptMetadata {
	...
	public Script(String name, String namespace, String[] exclude, String[] include, String[] match, String description, String downloadurl, String updateurl, String installurl, String icon, String runAt, boolean unwrap, String version, ScriptRequire[] requires, ScriptResource[] resources, String content) {
		super(name, namespace, exclude, include, match, description, downloadurl, updateurl, installurl, icon, runAt, unwrap, version, requires, resources);
	...
	public static Script parse(String scriptStr, String url) {
		...
		return new Script(name, namespace, excludeArr, includeArr, matchArr, description, downloadurl, updateurl, installurl, icon, runAt, unwrap, version, requireArr, resourceArr, scriptStr);
	}
