...
public class ScriptMetadata extends ScriptCriteria {
	...
	private final ScriptRequire[] requires;

	private final ScriptResource[] resources;

	private final boolean unwrap;

	private final String version;

	public ScriptMetadata(String name, String namespace, String[] exclude, String[] include, String[] match, String description, String downloadurl, String updateurl, String installurl, String icon, String runAt, boolean unwrap, String version, ScriptRequire[] requires, ScriptResource[] resources) {
